...
int mtk_mdp_frvc_process(struct mtk_mdp_ctx *ctx)
{
	...
	if (src_cfg->format == DP_COLOR_NV16 &&
		...
		if (src_cfg->crop_w == 720 && src_cfg->crop_h == 480 &&
			...
			nv16_720x480_yuyv_1920x1080(g_cmdq_handle,
				&vsi->src_buffer,
				&vsi->dst_buffer);
			...
			cmdqRecReset(g_cmdq_handle);
			nv16_720x480_yuyv_1080x1920(g_cmdq_handle,
				&vsi->src_buffer,
				&vsi->dst_buffer);
			ret = cmdqRecFlush(g_cmdq_handle);
			...
			vsi->misc.orientation == 0) {
			cmdqRecReset(g_cmdq_handle);
			nv16_1280x720_yuyv_1920x1080(g_cmdq_handle,
				&vsi->src_buffer,
				&vsi->dst_buffer);
			ret = cmdqRecFlush(g_cmdq_handle);
		} else if (src_cfg->crop_w == 1280 && src_cfg->crop_h == 720 &&
			...
			vsi->misc.orientation == 90) {
			cmdqRecReset(g_cmdq_handle);
			nv16_1280x720_yuyv_1080x1920(g_cmdq_handle,
				&vsi->src_buffer,
				&vsi->dst_buffer);
			ret = cmdqRecFlush(g_cmdq_handle);
		} else
