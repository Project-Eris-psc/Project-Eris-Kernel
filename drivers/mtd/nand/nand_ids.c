...
struct nand_flash_dev nand_flash_ids[] = {
	...
	{"MX30LF4G18AC 4G 3.3V 8-bit",
		{ .id = {0xC2, 0xDC, 0x90, 0x95, 0x56, 0x00} },
					SZ_2K, SZ_512, SZ_128K, 0, 5, 64},
	{"TC58NVG2S0HTA00 4G 3.3V 8-bit",
		{ .id = {0x98, 0xDC, 0x90, 0x26, 0x76, 0x16} },
					SZ_4K, SZ_512, SZ_256K, 0, 5, 256},
	{"MT29F8G08ABABA 8G 3.3V 8-bit",
		{ .id = {0x2C, 0x38, 0x00, 0x26, 0x85, 0x00} },
					SZ_4K, SZ_1K, SZ_512K, 0, 5, 224},
	{"MT29F2G08ABAEA 2G 3.3V 8-bit",
		{ .id = {0x2C, 0xDA, 0x90, 0x95, 0x06, 0x00} },
