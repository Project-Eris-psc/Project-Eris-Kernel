...
enum msc_chan_width {
	MSC_CHAN_WIDTH_20_NOHT, // =0
	MSC_CHAN_WIDTH_20,      // =1
	MSC_CHAN_WIDTH_40_PLUS, // =2
	MSC_CHAN_WIDTH_80,      // =3
	MSC_CHAN_WIDTH_80P80,   // =4
	MSC_CHAN_WIDTH_160,     // =5
	MSC_CHAN_WIDTH_5,       // =6
	MSC_CHAN_WIDTH_10,      // =7
	MSC_CHAN_WIDTH_40_MINUS,// =8
	MSC_CHAN_WIDVTH_20,     // =9
	MSC_CHAN_WIDVTH_40,     // =10
};
...
struct chan_info {
	int chan_id;
	enum msc_chan_width width; // for MT76xx
	int chan_width; // for MT66xx: 20, 40, 80, 160
	unsigned int flags;
};
