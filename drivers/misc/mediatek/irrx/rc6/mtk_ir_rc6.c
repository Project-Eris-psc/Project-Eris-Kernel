...
static int mtk_ir_rc6_suspend(void *preserve)
{
	...
	IR_WRITE32(IRRX_EXPBCNT, 0x1E);  /* bit[5:0]: set wake up except bit count, same to 0x0 bit[5:0] */
	IR_WRITE32(IRRX_PDWNOUT, 0x1);   /* pdwn_out */
	IR_WRITE32(IRRX_ENEXP_IRM, MTK_RC6_EXP_IRM_BIT_MASK);  /* SET ENEXP_IRM */
	IR_WRITE32(IRRX_ENEXP_IRL, MTK_RC6_EXP_IRL_BIT_MASK);  /* SET ENEXP_IRL */
	IR_WRITE32(IRRX_EXP_IRM1, MTK_RC6_EXP_POWE_KEY1);  /* NEC power key */
