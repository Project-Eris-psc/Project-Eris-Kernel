...
#else
		{
			MUINT32 dframerate = 0;
			get_default_framerate_by_scenario((MSDK_SCENARIO_ID_ENUM) *(feature_data), &dframerate);
			LOG_INF("default fps=%d, userptr 0x%lx(%d)\n",
				dframerate, (uintptr_t)(*(feature_data + 1)), sizeof(uintptr_t));

			if (copy_to_user
			    ((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&dframerate,
			     sizeof(uintptr_t))) {
				LOG_INF("[CAMERA_HW][get_default_frame_rate] ioctl copy to user failed\n");
			}
...
#else
			if (copy_to_user
				((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&imgsensor_winsize_info[1],
				 sizeof(SENSOR_WINSIZE_INFO_STRUCT))) {
				LOG_INF("[CAMERA_HW][get_crop_info] ioctl copy to user failed\n");
			}
#endif
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
...
#else
			if (copy_to_user
				((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&imgsensor_winsize_info[2],
				 sizeof(SENSOR_WINSIZE_INFO_STRUCT))) {
				LOG_INF("[CAMERA_HW][get_crop_info] ioctl copy to user failed\n");
			}
#endif
...
#else
			if (copy_to_user
				((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&imgsensor_winsize_info[3],
				 sizeof(SENSOR_WINSIZE_INFO_STRUCT))) {
				LOG_INF("[CAMERA_HW][get_crop_info] ioctl copy to user failed\n");
			}
#endif
...
#else
			if (copy_to_user
				((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&imgsensor_winsize_info[4],
				 sizeof(SENSOR_WINSIZE_INFO_STRUCT))) {
				LOG_INF("[CAMERA_HW][get_crop_info] ioctl copy to user failed\n");
			}
#endif
...
#else
			if (copy_to_user
				((void __user *)(uintptr_t)(*(feature_data + 1)), (void *)&imgsensor_winsize_info[0],
				 sizeof(SENSOR_WINSIZE_INFO_STRUCT))) {
				LOG_INF("[CAMERA_HW][get_crop_info] ioctl copy to user failed\n");
			}
#endif
