...
EXPORT_SYMBOL(cmdq_event_value);
static const u32 cmdq_event_value_8173[CMDQ_MAX_EVENT];
static const u32 cmdq_event_value_2712[CMDQ_MAX_EVENT];
static const u32 cmdq_event_value_8167[CMDQ_MAX_EVENT];
...
static const struct cmdq_subsys gce_subsys_8173[] = {
	{0x1400, 1},
	{0x1401, 2},
	{0x1402, 3},
	{0x0, -1},
...
static const struct cmdq_subsys gce_subsys_2712[] = {
	{0x1400, 1},
	{0x1401, 2},
	{0x1402, 3},
	{0x0, -1},
...
static const struct cmdq_subsys gce_subsys_8167[] = {
	{0x1400, 1},
	{0x1401, 2},
	{0x1402, 3},
	{0x0, -1},
...
static int cmdq_subsys_base_to_id(u32 base)
{
	...
	for (i = 0; gce_subsys != NULL && gce_subsys[i].base != 0u; i++)
...
struct cmdq_client *cmdq_mbox_create(struct device *dev, int index)
{
	...
	if (cmdq_event_value == NULL && !IS_ERR(client->chan)) {
		struct cmdq_priv *con_priv;

		con_priv = (struct cmdq_priv *)client->chan->con_priv;

		if (con_priv->plat == 8173u) {
			cmdq_event_value = cmdq_event_value_8173;
			gce_subsys = gce_subsys_8173;
		} else if (con_priv->plat == 2712u) {
			cmdq_event_value = cmdq_event_value_2712;
			gce_subsys = gce_subsys_2712;
		} else if (con_priv->plat == 8167u) {
			cmdq_event_value = cmdq_event_value_8167;
			gce_subsys = gce_subsys_8167;
		} else {
			pr_debug("unsupport cmdq for %u\n", con_priv->plat);
...
static const u32 cmdq_event_value_8167[CMDQ_MAX_EVENT] = {
	[CMDQ_EVENT_MDP_RDMA0_SOF] = 0,
	[CMDQ_EVENT_MDP_TDSHP0_SOF] = 3,
	[CMDQ_EVENT_MDP_WDMA_SOF] = 4,
	[CMDQ_EVENT_MDP_WROT0_SOF] = 5,
	[CMDQ_EVENT_DISP_OVL0_SOF] = 6,
	[CMDQ_EVENT_DISP_RDMA0_SOF] = 8,
	[CMDQ_EVENT_DISP_RDMA1_SOF] = 9,
	[CMDQ_EVENT_DISP_WDMA0_SOF] = 10,
	[CMDQ_EVENT_DISP_COLOR0_SOF] = 12,
	[CMDQ_EVENT_DISP_AAL0_SOF] = 13,
	[CMDQ_EVENT_DISP_GAMMA_SOF] = 14,
	[CMDQ_EVENT_DISP_UFOE_SOF] = 16,
	[CMDQ_EVENT_DISP_PWM0_SOF] = 17,
	[CMDQ_EVENT_MDP_RDMA0_EOF] = 18,
	[CMDQ_EVENT_MDP_RSZ0_EOF] = 19,
	[CMDQ_EVENT_MDP_RSZ1_EOF] = 20,
	[CMDQ_EVENT_MDP_TDSHP0_EOF] = 21,
	[CMDQ_EVENT_MDP_WDMA_EOF] = 22,
	[CMDQ_EVENT_MDP_WROT0_W_EOF] = 23,
	[CMDQ_EVENT_MDP_WROT0_R_EOF] = 24,
	[CMDQ_EVENT_DISP_OVL0_EOF] = 25,
	[CMDQ_EVENT_DISP_RDMA0_EOF] = 27,
	[CMDQ_EVENT_DISP_RDMA1_EOF] = 28,
	[CMDQ_EVENT_DISP_WDMA0_EOF] = 29,
	[CMDQ_EVENT_DISP_COLOR0_EOF] = 31,
	[CMDQ_EVENT_DISP_AAL0_EOF] = 32,
	[CMDQ_EVENT_DISP_GAMMA_EOF] = 33,
	[CMDQ_EVENT_DISP_UFOE_EOF] = 35,
	[CMDQ_EVENT_DISP_DPI0_EOF] = 36,
	[CMDQ_EVENT_DISP_DPI1_EOF] = 37,
	[CMDQ_EVENT_MUTEX0_STREAM_EOF] = 38,
	[CMDQ_EVENT_MUTEX1_STREAM_EOF] = 39,
	[CMDQ_EVENT_MUTEX2_STREAM_EOF] = 40,
	[CMDQ_EVENT_MUTEX3_STREAM_EOF] = 41,
	[CMDQ_EVENT_MUTEX4_STREAM_EOF] = 42,
	[CMDQ_EVENT_DISP_RDMA0_UNDERRUN] = 48,
	[CMDQ_EVENT_DISP_RDMA1_UNDERRUN] = 49,
};
